...
def get_segment_users_class():
    ...
    segment_users_table = Table('SF_CARLYLE_SEGMENT_USERS', metadata,
                                ...
                                Column('cf_36', String(250), nullable=True),
                                Column('cf_37', String(250), nullable=True),
                                Column('cf_38', String(250), nullable=True),
                                Column('cf_39', String(250), nullable=True),
                                Column('cf_40', String(250), nullable=True),
                                Column('cf_41', String(250), nullable=True),
                                Column('cf_42', String(250), nullable=True),
                                Column('cf_43', String(250), nullable=True),
                                Column('cf_44', String(250), nullable=True),
                                Column('cf_45', String(250), nullable=True),
                                Column('cf_46', String(250), nullable=True),
                                Column('cf_47', String(250), nullable=True),
                                Column('cf_48', String(250), nullable=True),
                                Column('cf_49', String(250), nullable=True),
                                Column('cf_50', String(250), nullable=True)
    )
...
def get_segment_class():
    ...
    segment_table = Table('SF_CARLYLE_SEGMENT', metadata,
                          ...
                          Column('cf_36_title', String(250), nullable=True),
                          Column('cf_37_title', String(250), nullable=True),
                          Column('cf_38_title', String(250), nullable=True),
                          Column('cf_39_title', String(250), nullable=True),
                          Column('cf_40_title', String(250), nullable=True),
                          Column('cf_41_title', String(250), nullable=True),
                          Column('cf_42_title', String(250), nullable=True),
                          Column('cf_43_title', String(250), nullable=True),
                          Column('cf_44_title', String(250), nullable=True),
                          Column('cf_45_title', String(250), nullable=True),
                          Column('cf_46_title', String(250), nullable=True),
                          Column('cf_47_title', String(250), nullable=True),
                          Column('cf_48_title', String(250), nullable=True),
                          Column('cf_49_title', String(250), nullable=True),
                          Column('cf_50_title', String(250), nullable=True),
                          ...
                          Column('cf_36_type', String(20), nullable=True),
                          Column('cf_37_type', String(20), nullable=True),
                          Column('cf_38_type', String(20), nullable=True),
                          Column('cf_39_type', String(20), nullable=True),
                          Column('cf_40_type', String(20), nullable=True),
                          Column('cf_41_type', String(20), nullable=True),
                          Column('cf_42_type', String(20), nullable=True),
                          Column('cf_43_type', String(20), nullable=True),
                          Column('cf_44_type', String(20), nullable=True),
                          Column('cf_45_type', String(20), nullable=True),
                          Column('cf_46_type', String(20), nullable=True),
                          Column('cf_47_type', String(20), nullable=True),
                          Column('cf_48_type', String(20), nullable=True),
                          Column('cf_49_type', String(20), nullable=True),
                          Column('cf_50_type', String(20), nullable=True)
    )
